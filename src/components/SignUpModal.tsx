...
export function SignUpModal({ isOpen, setIsOpen }: SignUpModalProps) {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Your account has been successfully created, and a credential was issued. We’ve sent
                    you an email with all of the details. You can know sign in using your credential.
                  </p>
                </div>
